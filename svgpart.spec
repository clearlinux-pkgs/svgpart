...
Version  : 21.04.2
Release  : 28
URL      : https://download.kde.org/stable/release-service/21.04.2/src/svgpart-21.04.2.tar.xz
Source0  : https://download.kde.org/stable/release-service/21.04.2/src/svgpart-21.04.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/21.04.2/src/svgpart-21.04.2.tar.xz.sig
...
%prep
%setup -q -n svgpart-21.04.2
cd %{_builddir}/svgpart-21.04.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1623436376
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/svgpart-21.04.2/LICENSES/GPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/svgpart/e712eadfab0d2357c0f50f599ef35ee0d87534cb
pushd clr-build
%make_install
popd
%find_lang svgpart
