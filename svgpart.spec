...
Source0  : https://download.kde.org/stable/release-service/25.04.1/src/svgpart-25.04.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/25.04.1/src/svgpart-25.04.1.tar.xz.sig
...
%setup -q -n svgpart-25.04.1
cd %{_builddir}/svgpart-25.04.1
pushd ..
cp -a svgpart-25.04.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1747073606
mkdir -p clr-build
pushd clr-build
