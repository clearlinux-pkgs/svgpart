...
Version  : 23.08.3
Release  : 58
URL      : https://download.kde.org/stable/release-service/23.08.3/src/svgpart-23.08.3.tar.xz
Source0  : https://download.kde.org/stable/release-service/23.08.3/src/svgpart-23.08.3.tar.xz
Source1  : https://download.kde.org/stable/release-service/23.08.3/src/svgpart-23.08.3.tar.xz.sig
...
%prep
%setup -q -n svgpart-23.08.3
cd %{_builddir}/svgpart-23.08.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1699544276
mkdir -p clr-build
pushd clr-build
